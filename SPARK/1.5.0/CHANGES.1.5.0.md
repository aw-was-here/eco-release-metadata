...
| [SPARK-9372](https://issues.apache.org/jira/browse/SPARK-9372) | For a join operator, rows with null equal join key expression can be filtered out early |  Major | SQL | Yin Huai | Yin Huai |
