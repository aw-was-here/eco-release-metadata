...
| [SPARK-4452](https://issues.apache.org/jira/browse/SPARK-4452) | Shuffle data structures can starve others on the same thread for memory |  Major | Spark Core | Tianshuo Deng | Tianshuo Deng |
