...
| [SPARK-3123](https://issues.apache.org/jira/browse/SPARK-3123) | override the "setName" function to set EdgeRDD\'s name manually just as VertexRDD does. |  Minor | GraphX | Genmao Yu |  |
