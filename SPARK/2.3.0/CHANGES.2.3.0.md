...
## Release 2.3.0 - Unreleased (as of 2018-01-25)
...
| [SPARK-16026](https://issues.apache.org/jira/browse/SPARK-16026) | Cost-based Optimizer Framework |  Major | SQL | Reynold Xin | Zhenhua Wang |
...
| [SPARK-22130](https://issues.apache.org/jira/browse/SPARK-22130) | UTF8String.trim() inefficiently scans all white-space string twice. |  Minor | Spark Core | Kazuaki Ishizaki | Kazuaki Ishizaki |
...
| [SPARK-22156](https://issues.apache.org/jira/browse/SPARK-22156) | incorrect learning rate update equation when numIterations \> 1 |  Minor | MLlib | kento nozawa | kento nozawa |
...
| [SPARK-20392](https://issues.apache.org/jira/browse/SPARK-20392) | Slow performance when calling fit on ML pipeline for dataset with many columns but few rows |  Major | ML | Barry Becker | Liang-Chi Hsieh |
...
| [SPARK-21975](https://issues.apache.org/jira/browse/SPARK-21975) | Histogram support in cost-based optimizer |  Major | SQL | Zhenhua Wang |  |
...
| [SPARK-21658](https://issues.apache.org/jira/browse/SPARK-21658) | Adds the default None for value in na.replace in PySpark to match |  Minor | PySpark | Hyukjin Kwon | Chin Han Yu |
...
| [SPARK-22303](https://issues.apache.org/jira/browse/SPARK-22303) | [SQL] Getting java.sql.SQLException: Unsupported type 101 for BINARY\_DOUBLE |  Minor | SQL | Kohki Nishio | Kohki Nishio |
...
| [SPARK-22279](https://issues.apache.org/jira/browse/SPARK-22279) | Turn on spark.sql.hive.convertMetastoreOrc by default |  Major | SQL | Dongjoon Hyun |  |
...
| [SPARK-21657](https://issues.apache.org/jira/browse/SPARK-21657) | Spark has exponential time complexity to explode(array of structs) |  Major | Spark Core, SQL | Ruslan Dautkhanov | Ohad Raviv |
...
| [SPARK-22036](https://issues.apache.org/jira/browse/SPARK-22036) | BigDecimal multiplication sometimes returns null |  Major | Spark Core | Olivier Blanvillain | Marco Gaido |
...
| [SPARK-23094](https://issues.apache.org/jira/browse/SPARK-23094) | Json Readers choose wrong encoding when bad records are present and fail |  Major | SQL | Burak Yavuz | Burak Yavuz |
...
| [SPARK-22078](https://issues.apache.org/jira/browse/SPARK-22078) | clarify exception behaviors for all data source v2 interfaces |  Major | SQL | Wenchen Fan |  |
...
| [SPARK-22785](https://issues.apache.org/jira/browse/SPARK-22785) | remove ColumnVector.anyNullsSet |  Major | SQL | Wenchen Fan | Wenchen Fan |
...
| [SPARK-22324](https://issues.apache.org/jira/browse/SPARK-22324) | Upgrade Arrow to version 0.8.0 |  Major | PySpark, SQL | Bryan Cutler | Bryan Cutler |
...
| [SPARK-23045](https://issues.apache.org/jira/browse/SPARK-23045) | Have RFormula use OneHoEncoderEstimator |  Major | ML | Bago Amirbekian | Bago Amirbekian |
...
| [SPARK-23127](https://issues.apache.org/jira/browse/SPARK-23127) | Update FeatureHasher user guide for catCols parameter |  Major | Documentation, ML | Nick Pentreath | Nick Pentreath |
...
| [SPARK-18085](https://issues.apache.org/jira/browse/SPARK-18085) | SPIP: Better History Server scalability for many / large applications |  Major | Spark Core, Web UI | Marcelo Vanzin |  |
