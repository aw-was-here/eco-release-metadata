...
| [HBASE-20411](https://issues.apache.org/jira/browse/HBASE-20411) | Ameliorate MutableSegment synchronize |  Major | . | stack | huaxiang sun |
...
| [HBASE-20661](https://issues.apache.org/jira/browse/HBASE-20661) | Move version from 2.0.0 to 2.0.1-SNAPSHOT in branch-2.0 |  Major | build | stack | stack |
...
| JIRA | Summary | Priority | Component | Reporter | Contributor |
|:---- |:---- | :--- |:---- |:---- |:---- |
| [HBASE-20539](https://issues.apache.org/jira/browse/HBASE-20539) | Disable IMC; part 2 |  Minor | in-memory-compaction | stack | stack |
| [HBASE-20520](https://issues.apache.org/jira/browse/HBASE-20520) | Failed effort upping default HDFS blocksize, hbase.regionserver.hlog.blocksize |  Major | conf | stack | stack |
| [HBASE-20564](https://issues.apache.org/jira/browse/HBASE-20564) | Tighter ByteBufferKeyValue Cell Comparator |  Major | Performance | stack | stack |
| [HBASE-20620](https://issues.apache.org/jira/browse/HBASE-20620) | Tighter ByteBufferKeyValue Cell Comparator; part 2 |  Major | Performance | stack | stack |
...
| [HBASE-20702](https://issues.apache.org/jira/browse/HBASE-20702) | Processing crash, skip ONLINE'ing empty rows |  Major | amv2 | stack | stack |
| [HBASE-20483](https://issues.apache.org/jira/browse/HBASE-20483) | [PERFORMANCE] Flushing is 2x slower in hbase2. |  Major | Performance | stack | stack |
...
| [HBASE-20721](https://issues.apache.org/jira/browse/HBASE-20721) | Set version on branch-2.0 to 2.0.1 in prep for 2.0.1 RC |  Major | . | stack | stack |
| [HBASE-20726](https://issues.apache.org/jira/browse/HBASE-20726) | Update RELEASENOTES.md and CHANGES.md for 2.0.1RC |  Major | . | stack | stack |
| [HBASE-20725](https://issues.apache.org/jira/browse/HBASE-20725) | Copy down docs from master branch (absent chapters on features not in 2.0.x) |  Major | documentation | stack | stack |
...
| [HBASE-20720](https://issues.apache.org/jira/browse/HBASE-20720) | Make 2.0.1 release |  Major | community | stack | stack |
