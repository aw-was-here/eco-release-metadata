...
| [ZOOKEEPER-2514](https://issues.apache.org/jira/browse/ZOOKEEPER-2514) | Simplify releasenotes creation for 3.4 branch - consistent with newer branches. |  Critical | documentation | Patrick Hunt | Patrick Hunt |
