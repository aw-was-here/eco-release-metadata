...
## Release 3.6.0 - Unreleased (as of 2020-11-14)
...
| JIRA | Summary | Priority | Component | Reporter | Contributor |
|:---- |:---- | :--- |:---- |:---- |:---- |
| [ZOOKEEPER-27](https://issues.apache.org/jira/browse/ZOOKEEPER-27) | Unique DB identifiers for servers and clients |  Major | c client, java client, server | Patrick D. Hunt |  |
...
| [ZOOKEEPER-3137](https://issues.apache.org/jira/browse/ZOOKEEPER-3137) | add a utility to truncate logs to a zxid |  Trivial | . | Brian Nixon | Brian Nixon |
...
| [ZOOKEEPER-3140](https://issues.apache.org/jira/browse/ZOOKEEPER-3140) | Allow Followers to host Observers |  Minor | server | Brian Nixon | Brian Nixon |
| [ZOOKEEPER-3209](https://issues.apache.org/jira/browse/ZOOKEEPER-3209) | New \`getEphemerals\` api to get all the ephemeral nodes created by the session |  Major | other | Dinesh Appavoo | Dinesh Appavoo |
| [ZOOKEEPER-3160](https://issues.apache.org/jira/browse/ZOOKEEPER-3160) | Custom User SSLContext |  Minor | java client | Alex Rankin | Alex Rankin |
| [ZOOKEEPER-3269](https://issues.apache.org/jira/browse/ZOOKEEPER-3269) | Testable facade would benefit from a queueEvent() method |  Major | java client | Jordan Zimmerman | Jordan Zimmerman |
| [ZOOKEEPER-3167](https://issues.apache.org/jira/browse/ZOOKEEPER-3167) | add an API and the corresponding CLI to get total count of recursive sub nodes under a specific path |  Minor | . | 田毅群 | maoling |
| [ZOOKEEPER-3343](https://issues.apache.org/jira/browse/ZOOKEEPER-3343) | Add a new doc: zookeeperTools.md |  Major | documentation | maoling | maoling |
| [ZOOKEEPER-3331](https://issues.apache.org/jira/browse/ZOOKEEPER-3331) | Automatically add IP authorization for Netty connections |  Trivial | server | Brian Nixon |  |
| [ZOOKEEPER-3244](https://issues.apache.org/jira/browse/ZOOKEEPER-3244) | Add option to snapshot based on log size |  Minor | server | Brian Nixon | Brian Nixon |
| [ZOOKEEPER-3311](https://issues.apache.org/jira/browse/ZOOKEEPER-3311) | Allow a delay to the transaction log flush |  Minor | server | Brian Nixon | Brian Nixon |
| [ZOOKEEPER-3092](https://issues.apache.org/jira/browse/ZOOKEEPER-3092) | Pluggable metrics system for ZooKeeper |  Major | metric system | Michael Han | Enrico Olivelli |
| [ZOOKEEPER-3091](https://issues.apache.org/jira/browse/ZOOKEEPER-3091) | Prometheus.io integration |  Major | jmx, metric system | Hari Sekhon |  |
| [ZOOKEEPER-1634](https://issues.apache.org/jira/browse/ZOOKEEPER-1634) | A new feature proposal to ZooKeeper: authentication enforcement |  Major | security, server | Jaewoong Choi | Michael Han |
| [ZOOKEEPER-3371](https://issues.apache.org/jira/browse/ZOOKEEPER-3371) | Port unification for admin server |  Major | security | Eric Lee | Eric Lee |
| [ZOOKEEPER-3447](https://issues.apache.org/jira/browse/ZOOKEEPER-3447) | add a doc: zookeeperMonitor.md |  Major | documentation | maoling | maoling |
| [ZOOKEEPER-3344](https://issues.apache.org/jira/browse/ZOOKEEPER-3344) | write a new script:zkSnapShotToolkit.sh to encapsulate SnapshotFormatter and doc the usage |  Major | scripts | maoling | maoling |
| [ZOOKEEPER-1260](https://issues.apache.org/jira/browse/ZOOKEEPER-1260) | Audit logging in ZooKeeper servers. |  Major | server | Mahadev Konar | Mohammad Arshad |
| [ZOOKEEPER-3114](https://issues.apache.org/jira/browse/ZOOKEEPER-3114) | Built-in data consistency check inside ZooKeeper |  Major | quorum | Fangmin Lv | Fangmin Lv |
...
| [ZOOKEEPER-2176](https://issues.apache.org/jira/browse/ZOOKEEPER-2176) | Unclear error message should be info not error |  Major | quorum | Raúl Gutiérrez Segalés | Raúl Gutiérrez Segalés |
...
| [ZOOKEEPER-2098](https://issues.apache.org/jira/browse/ZOOKEEPER-2098) | QuorumCnxManager: use BufferedOutputStream for initial msg |  Major | quorum, server | Raúl Gutiérrez Segalés | Raúl Gutiérrez Segalés |
...
| [ZOOKEEPER-1423](https://issues.apache.org/jira/browse/ZOOKEEPER-1423) | 4lw and jmx should expose the size of the datadir/datalogdir |  Major | jmx | Patrick D. Hunt | Edward Ribeiro |
...
| [ZOOKEEPER-3353](https://issues.apache.org/jira/browse/ZOOKEEPER-3353) | Admin commands for showing initial settings |  Minor | server | Brian Nixon | Brian Nixon |
...
| [ZOOKEEPER-3472](https://issues.apache.org/jira/browse/ZOOKEEPER-3472) | Treat check request as a write request which needs to wait for the check txn commit from leader |  Major | server | Fangmin Lv | Fangmin Lv |
...
| [ZOOKEEPER-3620](https://issues.apache.org/jira/browse/ZOOKEEPER-3620) | Allow to override calls to System.exit in server side code |  Major | server, tests | Enrico Olivelli | Enrico Olivelli |
...
| [ZOOKEEPER-3072](https://issues.apache.org/jira/browse/ZOOKEEPER-3072) | Race condition in throttling |  Major | server | Botond Hejj | Botond Hejj |
...
| [ZOOKEEPER-3144](https://issues.apache.org/jira/browse/ZOOKEEPER-3144) | Potential ephemeral nodes inconsistent due to global session inconsistent with fuzzy snapshot |  Critical | server | Fangmin Lv | Fangmin Lv |
| [ZOOKEEPER-2847](https://issues.apache.org/jira/browse/ZOOKEEPER-2847) | Cannot bind to client port when reconfig based on old static config |  Major | server | Fangmin Lv | Yisong Yue |
...
| [ZOOKEEPER-2325](https://issues.apache.org/jira/browse/ZOOKEEPER-2325) | Data inconsistency if all snapshots empty or missing |  Critical | server | Andrew Grasso | Andrew Grasso |
...
| [ZOOKEEPER-3212](https://issues.apache.org/jira/browse/ZOOKEEPER-3212) | Fix website with adding doap.rdf back |  Major | other | Tamas Penzes | Tamas Penzes |
...
| [ZOOKEEPER-3218](https://issues.apache.org/jira/browse/ZOOKEEPER-3218) | zk server reopened，the interval for observer connect to the new leader is too long，then session expired |  Major | . | yangoofy |  |
...
| [ZOOKEEPER-3306](https://issues.apache.org/jira/browse/ZOOKEEPER-3306) | Node may not accessible due the the inconsistent ACL reference map after SNAP sync |  Critical | server | Fangmin Lv | Fangmin Lv |
...
| [ZOOKEEPER-3399](https://issues.apache.org/jira/browse/ZOOKEEPER-3399) | Remove logging in getGlobalOutstandingLimit for optimal performance. |  Major | server | Michael Han | Michael Han |
...
| [ZOOKEEPER-3296](https://issues.apache.org/jira/browse/ZOOKEEPER-3296) | Cannot join quorum due to Quorum SSLSocket connection not closed explicitly when there is handshake issue |  Major | server | Fangmin Lv | Fangmin Lv |
...
| [ZOOKEEPER-2418](https://issues.apache.org/jira/browse/ZOOKEEPER-2418) | txnlog diff sync can skip sending some transactions to followers |  Critical | server | Nicholas Wolchko | Brian Nixon |
| [ZOOKEEPER-2563](https://issues.apache.org/jira/browse/ZOOKEEPER-2563) | A revisit to setquota |  Major | server | Rakesh Kumar Singh | Rakesh Kumar Singh |
| [ZOOKEEPER-3356](https://issues.apache.org/jira/browse/ZOOKEEPER-3356) | Request throttling in Netty is not working as expected and could cause direct buffer OOM issue |  Major | server | Fangmin Lv | Fangmin Lv |
| [ZOOKEEPER-3479](https://issues.apache.org/jira/browse/ZOOKEEPER-3479) | Logging false leader election times |  Minor | leaderElection | Karolos Antoniadis | Karolos Antoniadis |
| [ZOOKEEPER-3373](https://issues.apache.org/jira/browse/ZOOKEEPER-3373) | need change description for "Single System Image" guarantee in document |  Minor | documentation | Jiahongchao | Jiahongchao |
...
| [ZOOKEEPER-3540](https://issues.apache.org/jira/browse/ZOOKEEPER-3540) | Client port unavailable after binding the same client port during reconfig |  Major | server | Fangmin Lv | Fangmin Lv |
| [ZOOKEEPER-3145](https://issues.apache.org/jira/browse/ZOOKEEPER-3145) | Potential watch missing issue due to stale pzxid when replaying CloseSession txn with fuzzy snapshot |  Critical | server | Fangmin Lv | Fangmin Lv |
...
| [ZOOKEEPER-3531](https://issues.apache.org/jira/browse/ZOOKEEPER-3531) | Synchronization on ACLCache cause cluster to hang when network/disk issues happen during datatree serialization |  Critical | . | Chang Lou | Chang Lou |
| [ZOOKEEPER-3471](https://issues.apache.org/jira/browse/ZOOKEEPER-3471) | Potential lock unavailable due to dangling ephemeral nodes left during local session upgrading |  Critical | server | Fangmin Lv | Fangmin Lv |
| [ZOOKEEPER-3605](https://issues.apache.org/jira/browse/ZOOKEEPER-3605) | ZOOKEEPER-3242 add a connection throttle. Default constructor needs to set it |  Major | server | Jordan Zimmerman |  |
...
| [ZOOKEEPER-3546](https://issues.apache.org/jira/browse/ZOOKEEPER-3546) | Containers that never have children stay forever |  Major | server | Sylvain Wallez | Jordan Zimmerman |
...
| [ZOOKEEPER-3641](https://issues.apache.org/jira/browse/ZOOKEEPER-3641) | New ZOO\_VERSION define breaks Perl & Python contribs |  Major | c client | Damien Diederen |  |
...
| [ZOOKEEPER-1936](https://issues.apache.org/jira/browse/ZOOKEEPER-1936) | Server exits when unable to create data directory due to race |  Minor | server | Harald Musum | Ted Yu |
...
| [ZOOKEEPER-3157](https://issues.apache.org/jira/browse/ZOOKEEPER-3157) | Improve FuzzySnapshotRelatedTest to avoid flaky due to issues like connection loss |  Minor | tests | Fangmin Lv | Andor Molnar |
...
| [ZOOKEEPER-3205](https://issues.apache.org/jira/browse/ZOOKEEPER-3205) | Jute - o.a.jute.BinaryInputArchive Test cases |  Minor | jute | Karthik K | Karthik K |
...
| [ZOOKEEPER-3480](https://issues.apache.org/jira/browse/ZOOKEEPER-3480) | Flaky test CommitProcessorMetricsTest.testConcurrentRequestProcessingInCommitProcessor |  Minor | tests | Fangmin Lv | Fangmin Lv |
| [ZOOKEEPER-3495](https://issues.apache.org/jira/browse/ZOOKEEPER-3495) | Broken test in JDK12+: SnapshotDigestTest.testDifferentDigestVersion |  Minor | . | Andor Molnar | Mate Szalay-Beko |
...
| [ZOOKEEPER-1626](https://issues.apache.org/jira/browse/ZOOKEEPER-1626) | Zookeeper C client should be tolerant of clock adjustments |  Major | c client | Colin McCabe | Colin McCabe |
...
| [ZOOKEEPER-169](https://issues.apache.org/jira/browse/ZOOKEEPER-169) | Content needed: "Connecting to ZooKeeper" |  Major | documentation | Robbie Scott | Michael Tanenblatt |
...
| [ZOOKEEPER-2753](https://issues.apache.org/jira/browse/ZOOKEEPER-2753) | Introduce a python script for generating flaky test report |  Major | tests | Michael Han | Michael Han |
...
| [ZOOKEEPER-3233](https://issues.apache.org/jira/browse/ZOOKEEPER-3233) | Run github pre-commit hook tests on 4 threads |  Major | tests | Andor Molnar | Andor Molnar |
...
| [ZOOKEEPER-3251](https://issues.apache.org/jira/browse/ZOOKEEPER-3251) | Add new server metric types: percentile counter and counter set |  Major | server | Jie Huang | Jie Huang |
...
| [ZOOKEEPER-3267](https://issues.apache.org/jira/browse/ZOOKEEPER-3267) | Add watcher metrics |  Minor | server | Jie Huang | Jie Huang |
...
| [ZOOKEEPER-3327](https://issues.apache.org/jira/browse/ZOOKEEPER-3327) | Add unrecoverable error count |  Minor | metric system | Jie Huang | Jie Huang |
...
| [ZOOKEEPER-3324](https://issues.apache.org/jira/browse/ZOOKEEPER-3324) | Add read/write metrics for top level znodes |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3143](https://issues.apache.org/jira/browse/ZOOKEEPER-3143) | Pluggable metrics system for ZooKeeper - Data Collection on Server |  Major | metric system | Enrico Olivelli | Enrico Olivelli |
| [ZOOKEEPER-3310](https://issues.apache.org/jira/browse/ZOOKEEPER-3310) | Add metrics for prep processor |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3326](https://issues.apache.org/jira/browse/ZOOKEEPER-3326) | Add session/connection related metrics |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3268](https://issues.apache.org/jira/browse/ZOOKEEPER-3268) | Add commit processor metrics |  Minor | server | Jie Huang | Jie Huang |
| [ZOOKEEPER-3319](https://issues.apache.org/jira/browse/ZOOKEEPER-3319) | Add metrics for follower and observer |  Major | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3305](https://issues.apache.org/jira/browse/ZOOKEEPER-3305) | Add Quorum Packet metrics |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3383](https://issues.apache.org/jira/browse/ZOOKEEPER-3383) | Improve prep processor metric accuracy and de-flaky unit test |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3323](https://issues.apache.org/jira/browse/ZOOKEEPER-3323) | Add TxnSnapLog metrics |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3379](https://issues.apache.org/jira/browse/ZOOKEEPER-3379) | De-flaky test in Quorum Packet Metrics |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3401](https://issues.apache.org/jira/browse/ZOOKEEPER-3401) | Fix metric PROPOSAL\_ACK\_CREATION\_LATENCY |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3409](https://issues.apache.org/jira/browse/ZOOKEEPER-3409) | Compile Java code with -Xdoclint |  Major | build | Enrico Olivelli | Enrico Olivelli |
| [ZOOKEEPER-3366](https://issues.apache.org/jira/browse/ZOOKEEPER-3366) | Pluggable metrics system for ZooKeeper - move remaining metrics to MetricsProvider |  Major | metric system | Enrico Olivelli | Enrico Olivelli |
| [ZOOKEEPER-3309](https://issues.apache.org/jira/browse/ZOOKEEPER-3309) | Add sync processor metrics |  Minor | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3321](https://issues.apache.org/jira/browse/ZOOKEEPER-3321) | Add metrics for Leader |  Major | metric system | Jie Huang | Jie Huang |
| [ZOOKEEPER-3288](https://issues.apache.org/jira/browse/ZOOKEEPER-3288) | add a new doc:ZookeeperCLI.md |  Major | documentation | maoling | maoling |
...
| [ZOOKEEPER-3465](https://issues.apache.org/jira/browse/ZOOKEEPER-3465) | Introduce BookKeeper checkstyle configuration |  Major | build | Zili Chen | Zili Chen |
| [ZOOKEEPER-3150](https://issues.apache.org/jira/browse/ZOOKEEPER-3150) | Data integrity check when loading snapshot/txns from disk |  Major | server | Fangmin Lv | Fangmin Lv |
| [ZOOKEEPER-3474](https://issues.apache.org/jira/browse/ZOOKEEPER-3474) | Enable BookKeeper checkstyle configuration on zookeeper-promethus |  Major | build | Zili Chen | Zili Chen |
| [ZOOKEEPER-3475](https://issues.apache.org/jira/browse/ZOOKEEPER-3475) | Enable BookKeeper checkstyle configuration on zookeeper-server |  Major | build | Zili Chen | Zili Chen |
| [ZOOKEEPER-3517](https://issues.apache.org/jira/browse/ZOOKEEPER-3517) | Turn on BookKeeper checkstyle configuration at project level |  Major | build | Zili Chen | Zili Chen |
| [ZOOKEEPER-3528](https://issues.apache.org/jira/browse/ZOOKEEPER-3528) | Revisit AsyncCallback javadoc |  Major | documentation | Zili Chen | Zili Chen |
| [ZOOKEEPER-3529](https://issues.apache.org/jira/browse/ZOOKEEPER-3529) | add a new doc: zookeeperUseCases.md |  Major | documentation | maoling | maoling |
| [ZOOKEEPER-3470](https://issues.apache.org/jira/browse/ZOOKEEPER-3470) | Flaky test: LearnerMetricsTest.testLearnerMetricsTest() |  Major | tests | Andor Molnar | Mate Szalay-Beko |
| [ZOOKEEPER-2122](https://issues.apache.org/jira/browse/ZOOKEEPER-2122) | Impplement SSL support in the Zookeeper C client library |  Trivial | c client | Ashish Amarnath | Mate Szalay-Beko |
| [ZOOKEEPER-3512](https://issues.apache.org/jira/browse/ZOOKEEPER-3512) | Real time data integrity check during broadcast time |  Major | server | Fangmin Lv | Fangmin Lv |
...
| [ZOOKEEPER-3302](https://issues.apache.org/jira/browse/ZOOKEEPER-3302) | ZooKeeper C client does not compile on Fedora 29 |  Blocker | c client | Enrico Olivelli | Enrico Olivelli |
| [ZOOKEEPER-3421](https://issues.apache.org/jira/browse/ZOOKEEPER-3421) | Better insight into Observer connections |  Minor | server | Brian Nixon |  |
...
| [ZOOKEEPER-3002](https://issues.apache.org/jira/browse/ZOOKEEPER-3002) | Upgrade branches 3.5 and trunk to Java 1.8 |  Major | java client, server | Andor Molnar | Norbert Kalmár |
...
| [ZOOKEEPER-3067](https://issues.apache.org/jira/browse/ZOOKEEPER-3067) | Optionally suppress client environment logging. |  Minor | c client | James Peach | James Peach |
| [ZOOKEEPER-3061](https://issues.apache.org/jira/browse/ZOOKEEPER-3061) | add more details to 'Unhandled scenario for peer' log.warn message |  Minor | . | Christine Poerschke | Christine Poerschke |
...
| [ZOOKEEPER-3406](https://issues.apache.org/jira/browse/ZOOKEEPER-3406) | Update website for new mailing lists |  Minor | . | Lars Francke |  |
| [ZOOKEEPER-3407](https://issues.apache.org/jira/browse/ZOOKEEPER-3407) | Update POM file with new information |  Trivial | . | Lars Francke | Lars Francke |
...
| [ZOOKEEPER-3431](https://issues.apache.org/jira/browse/ZOOKEEPER-3431) | Enable BookKeeper checkstyle configuration |  Major | build | maoling | Zili Chen |
...
| [ZOOKEEPER-3668](https://issues.apache.org/jira/browse/ZOOKEEPER-3668) | Clean up release package for 3.6.0 |  Blocker | build, license | Enrico Olivelli | Enrico Olivelli |
...
| [ZOOKEEPER-3635](https://issues.apache.org/jira/browse/ZOOKEEPER-3635) | Use Docker and Maven Release Plugin to prepare ZooKeeper releases |  Major | build | Enrico Olivelli | Enrico Olivelli |
