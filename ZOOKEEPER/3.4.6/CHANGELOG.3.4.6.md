...
| [ZOOKEEPER-1805](https://issues.apache.org/jira/browse/ZOOKEEPER-1805) | "Don't care" value in ZooKeeper election breaks rolling upgrades |  Blocker | . | Flavio Paiva Junqueira | Flavio Paiva Junqueira |
...
| [ZOOKEEPER-805](https://issues.apache.org/jira/browse/ZOOKEEPER-805) | four letter words fail with latest ubuntu nc.openbsd |  Critical | documentation, server | Patrick D. Hunt |  |
...
| JIRA | Summary | Priority | Component | Reporter | Contributor |
|:---- |:---- | :--- |:---- |:---- |:---- |
| [ZOOKEEPER-1558](https://issues.apache.org/jira/browse/ZOOKEEPER-1558) | Leader should not snapshot uncommitted state |  Blocker | quorum | Flavio Paiva Junqueira | Flavio Paiva Junqueira |
| [ZOOKEEPER-1808](https://issues.apache.org/jira/browse/ZOOKEEPER-1808) | Add version to FLE notifications for 3.4 branch |  Blocker | . | Flavio Paiva Junqueira | Flavio Paiva Junqueira |
| [ZOOKEEPER-1817](https://issues.apache.org/jira/browse/ZOOKEEPER-1817) | Fix don't care for b3.4 |  Blocker | . | Flavio Paiva Junqueira | Flavio Paiva Junqueira |
