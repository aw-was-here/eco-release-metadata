...
| [HIVE-12721](https://issues.apache.org/jira/browse/HIVE-12721) | Add UUID built in function |  Major | UDF | Jacob Evan Beard | Jacob Evan Beard |
...
| [HIVE-14542](https://issues.apache.org/jira/browse/HIVE-14542) | VirtualColumn::equals() should use object equality |  Minor | Query Processor, Transactions | Gopal Vijayaraghavan | Eugene Koifman |
...
| [HIVE-5867](https://issues.apache.org/jira/browse/HIVE-5867) | JDBC driver and beeline should support executing an initial SQL script |  Major | Clients, JDBC | Prasad Suresh Mujumdar | Jianguo Tian |
...
| [HIVE-5469](https://issues.apache.org/jira/browse/HIVE-5469) | support nullif |  Minor | . | N Campbell | Navis Ryu |
...
| [HIVE-15713](https://issues.apache.org/jira/browse/HIVE-15713) | add ldap authentication related configuration to restricted list |  Minor | HiveServer2 | Anishek Agarwal | Anishek Agarwal |
| [HIVE-15712](https://issues.apache.org/jira/browse/HIVE-15712) | new HiveConf in SQLOperation.getSerDe() impacts CPU on hiveserver2 |  Major | HiveServer2 | Anishek Agarwal | Anishek Agarwal |
...
| [HIVE-16045](https://issues.apache.org/jira/browse/HIVE-16045) | Print progress bar along with operation log |  Major | HiveServer2 | Anishek Agarwal | Anishek Agarwal |
...
| [HIVE-16115](https://issues.apache.org/jira/browse/HIVE-16115) | Stop printing progress info from operation logs with beeline progress bar |  Minor | HiveServer2 | Anishek Agarwal | Anishek Agarwal |
| [HIVE-16182](https://issues.apache.org/jira/browse/HIVE-16182) | Semijoin: Avoid VectorHashKeyWrapper allocations for the bloom hash aggregate |  Major | Vectorization | Gopal Vijayaraghavan | Gopal Vijayaraghavan |
...
| [HIVE-13780](https://issues.apache.org/jira/browse/HIVE-13780) | Allow user to update AVRO table schema via command even if table's definition was defined through schema file |  Minor | CLI | Eric Lin | Ádám Szita |
...
| [HIVE-14016](https://issues.apache.org/jira/browse/HIVE-14016) | Vectorization: Add support for Grouping Sets |  Major | Vectorization | Gopal Vijayaraghavan | Matt McCline |
| [HIVE-15573](https://issues.apache.org/jira/browse/HIVE-15573) | Vectorization: Non-Uniform shuffle ReduceSink is not specialized |  Major | Transactions, Vectorization | Gopal Vijayaraghavan | Matt McCline |
...
| [HIVE-14256](https://issues.apache.org/jira/browse/HIVE-14256) | CBO: Rewrite aggregate + distinct as 3-stage DAG |  Major | CBO | Gopal Vijayaraghavan |  |
...
| [HIVE-13887](https://issues.apache.org/jira/browse/HIVE-13887) | LazySimpleSerDe should parse "NULL" dates faster |  Major | Serializers/Deserializers, Vectorization | Gopal Vijayaraghavan | Gopal Vijayaraghavan |
...
| [HIVE-14200](https://issues.apache.org/jira/browse/HIVE-14200) | Tez: disable auto-reducer parallelism when reducer-count \* min.partition.factor \< 1.0 |  Major | . | Gopal Vijayaraghavan | Gopal Vijayaraghavan |
...
| [HIVE-14345](https://issues.apache.org/jira/browse/HIVE-14345) | Beeline result table has erroneous characters |  Minor | Beeline | Jacob Evan Beard | Miklos Csanady |
...
| [HIVE-14155](https://issues.apache.org/jira/browse/HIVE-14155) | Vectorization: Custom UDF Vectorization annotations are ignored |  Major | UDF, Vectorization | Gopal Vijayaraghavan | Gopal Vijayaraghavan |
...
| [HIVE-14686](https://issues.apache.org/jira/browse/HIVE-14686) | Get unexpected command type when execute query "CREATE TABLE IF NOT EXISTS ... AS" |  Major | . | Yunbo Fan | Yunbo Fan |
...
| [HIVE-3173](https://issues.apache.org/jira/browse/HIVE-3173) | implement getTypeInfo database metadata method |  Major | JDBC | N Campbell | Xiu Guo |
...
| [HIVE-13589](https://issues.apache.org/jira/browse/HIVE-13589) | beeline support prompt for password with '-p' option |  Major | Beeline | Thejas Nair | Vihang Karajgaonkar |
...
| [HIVE-15096](https://issues.apache.org/jira/browse/HIVE-15096) | hplsql registerUDF conflicts with pom.xml |  Major | hpl/sql | Hui Fei | Hui Fei |
...
| [HIVE-15191](https://issues.apache.org/jira/browse/HIVE-15191) | Fix typo in conf/hive-env.sh.template |  Trivial | . | Dongjin Lee | Dongjin Lee |
...
| [HIVE-15257](https://issues.apache.org/jira/browse/HIVE-15257) | remove useless cleanupReaders in OrcEncodedDataReader |  Major | llap | Hui Fei | Hui Fei |
...
| [HIVE-15378](https://issues.apache.org/jira/browse/HIVE-15378) | clean up HADOOP\_USER\_CLASSPATH\_FIRST in bin scripts |  Major | Build Infrastructure | Hui Fei | Hui Fei |
...
| [HIVE-14384](https://issues.apache.org/jira/browse/HIVE-14384) | CBO: Decimal constant folding is failing |  Major | CBO | Gopal Vijayaraghavan | Jesus Camacho Rodriguez |
...
| [HIVE-14707](https://issues.apache.org/jira/browse/HIVE-14707) | ACID: Insert shuffle sort-merges on blank KEY |  Major | Transactions | Gopal Vijayaraghavan | Eugene Koifman |
...
| [HIVE-15579](https://issues.apache.org/jira/browse/HIVE-15579) | Support HADOOP\_PROXY\_USER for secure impersonation in hive metastore client |  Major | . | Thejas Nair | Nanda kumar |
...
| [HIVE-15778](https://issues.apache.org/jira/browse/HIVE-15778) | DROP INDEX (non-existent) throws NPE when using DbNotificationListener |  Major | Metastore | Vamsee K. Yarlagadda | Vamsee K. Yarlagadda |
...
| [HIVE-14573](https://issues.apache.org/jira/browse/HIVE-14573) | Vectorization: Implement StringExpr::find() |  Major | . | Gopal Vijayaraghavan | Teddy Choi |
...
| [HIVE-15730](https://issues.apache.org/jira/browse/HIVE-15730) | JDBC should use SQLFeatureNotSupportedException where appropriate instead of  SQLException |  Major | JDBC | Thejas Nair | Sankar Hariappan |
...
| [HIVE-15855](https://issues.apache.org/jira/browse/HIVE-15855) | throws NPE when using Hplsql UDF |  Major | hpl/sql | Hui Fei | Hui Fei |
...
| [HIVE-15878](https://issues.apache.org/jira/browse/HIVE-15878) | LLAP text cache: bug in last merge |  Major | . | Gopal Vijayaraghavan | Sergey Shelukhin |
...
| [HIVE-15847](https://issues.apache.org/jira/browse/HIVE-15847) | In Progress update refreshes seem slow |  Major | Hive | Anishek Agarwal | Anishek Agarwal |
...
| [HIVE-16004](https://issues.apache.org/jira/browse/HIVE-16004) | OutOfMemory in SparkReduceRecordHandler with vectorization mode |  Major | . | Colin | Colin |
...
| [HIVE-16043](https://issues.apache.org/jira/browse/HIVE-16043) | TezConfiguration.TEZ\_QUEUE\_NAME instead of tez.queue.name |  Major | Tez | Hui Fei | Hui Fei |
...
| [HIVE-15407](https://issues.apache.org/jira/browse/HIVE-15407) | add distcp to classpath by default, because hive depends on it. |  Major | Beeline, CLI | Hui Fei | Hui Fei |
...
| [HIVE-16187](https://issues.apache.org/jira/browse/HIVE-16187) | Flaky Tests:TestHostAffinitySplitLocationProvider#testConsistentHashingFallback usually timed out |  Major | Tests | Hui Fei | Hui Fei |
...
| [HIVE-15849](https://issues.apache.org/jira/browse/HIVE-15849) | hplsql should add enterGlobalScope func to UDF |  Major | hpl/sql | Hui Fei | Hui Fei |
...
| [HIVE-15789](https://issues.apache.org/jira/browse/HIVE-15789) | Vectorization: limit reduce vectorization to 32Mb chunks |  Major | Vectorization | Gopal Vijayaraghavan | Teddy Choi |
...
| [HIVE-16208](https://issues.apache.org/jira/browse/HIVE-16208) | Vectorization: ProcessingModeHashAggregate::sumBatchSize is never reset |  Minor | . | Gopal Vijayaraghavan | Gopal Vijayaraghavan |
...
| [HIVE-14801](https://issues.apache.org/jira/browse/HIVE-14801) | improve TestPartitionNameWhitelistValidation stability |  Major | . | Thejas Nair | Thejas Nair |
...
| [HIVE-14973](https://issues.apache.org/jira/browse/HIVE-14973) | Flaky test: TestJdbcWithSQLAuthorization.testBlackListedUdfUsage |  Major | Tests | Gopal Vijayaraghavan | Zoltan Haindrich |
...
| [HIVE-14974](https://issues.apache.org/jira/browse/HIVE-14974) | TestBeeLineHistory throws NPE in ShutdownHook |  Major | Tests | Gopal Vijayaraghavan | Prasanth Jayachandran |
| [HIVE-14977](https://issues.apache.org/jira/browse/HIVE-14977) | Flaky test: fix order\_null.q and union\_fast\_stats.q |  Major | Tests | Gopal Vijayaraghavan | Prasanth Jayachandran |
...
| [HIVE-15745](https://issues.apache.org/jira/browse/HIVE-15745) | TestMiniLlapLocalCliDriver. vector\_varchar\_simple,vector\_char\_simple |  Major | . | Thejas Nair | Matt McCline |
| [HIVE-14827](https://issues.apache.org/jira/browse/HIVE-14827) | Micro benchmark for Parquet vectorized reader |  Major | . | Ferdinand Xu | Colin |
...
| [HIVE-15718](https://issues.apache.org/jira/browse/HIVE-15718) | Fix the NullPointer problem caused by split phase |  Critical | . | Colin | Colin |
...
| [HIVE-15702](https://issues.apache.org/jira/browse/HIVE-15702) | Test timeout : TestDerbyConnector |  Major | . | Thejas Nair | Slim Bouguerra |
...
| [HIVE-15744](https://issues.apache.org/jira/browse/HIVE-15744) | Flaky test: TestPerfCliDriver.query23, query14 |  Major | . | Thejas Nair | Ashutosh Chauhan |
