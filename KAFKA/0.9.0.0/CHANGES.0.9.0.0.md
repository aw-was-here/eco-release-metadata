...
| [KAFKA-2531](https://issues.apache.org/jira/browse/KAFKA-2531) | Add Ducktape based tests for KafkaLog4jAppender |  Major | . | Ashish Singh | Ashish Singh |
...
| [KAFKA-2196](https://issues.apache.org/jira/browse/KAFKA-2196) | remove roundrobin identical topic constraint in consumer coordinator |  Major | . | Onur Karaman | Onur Karaman |
...
| [KAFKA-1893](https://issues.apache.org/jira/browse/KAFKA-1893) | Allow regex subscriptions in the new consumer |  Blocker | consumer | Jay Kreps | Ashish Singh |
