...
| [HADOOP-11208](https://issues.apache.org/jira/browse/HADOOP-11208) | Replace "daemon" with better name in script subcommands |  Major |  | Yongjun Zhang | Allen Wittenauer |
...
| [HADOOP-11058](https://issues.apache.org/jira/browse/HADOOP-11058) | Missing HADOOP_CONF_DIR generates strange results |  Major | (scripts) | Allen Wittenauer | Masatake Iwasaki |
...
| [HADOOP-8719](https://issues.apache.org/jira/browse/HADOOP-8719) | Workaround for kerberos-related log errors upon running any hadoop command on OSX |  Trivial |  | Jianbin Wei | Jianbin Wei |
...
| [YARN-2472](https://issues.apache.org/jira/browse/YARN-2472) | yarn-daemons.sh should just call yarn directly |  Major |  | Allen Wittenauer | Masatake Iwasaki |
...
| [HADOOP-11397](https://issues.apache.org/jira/browse/HADOOP-11397) | Can't override HADOOP_IDENT_STRING |  Trivial |  | Allen Wittenauer | Kengo Seki |
...
| [HADOOP-11052](https://issues.apache.org/jira/browse/HADOOP-11052) | hadoop_verify_secure_prereq's results aren't checked in bin/hdfs |  Critical | (scripts) | Allen Wittenauer | Allen Wittenauer |
| [HADOOP-11033](https://issues.apache.org/jira/browse/HADOOP-11033) | shell scripts ignore JAVA_HOME on OS X |  Major | (scripts) | Lei (Eddy) Xu | Allen Wittenauer |
