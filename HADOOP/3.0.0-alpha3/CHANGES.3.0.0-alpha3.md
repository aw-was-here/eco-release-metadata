...
## Release 3.0.0-alpha3 - Unreleased (as of 2017-03-24)
...
| [HDFS-9705](https://issues.apache.org/jira/browse/HDFS-9705) | Refine the behaviour of getFileChecksum when length = 0 |  Minor | . | Kai Zheng | Kai Zheng |
