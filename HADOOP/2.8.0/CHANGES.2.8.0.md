...
| [HDFS-6682](https://issues.apache.org/jira/browse/HDFS-6682) | Add a metric to expose the timestamp of the oldest under-replicated block |  Major | . | Akira AJISAKA | Akira AJISAKA |
