...
## Release 0.11 - Unreleased (as of 2017-08-28)
...
| [FALCON-2039](https://issues.apache.org/jira/browse/FALCON-2039) | Move falcon post processing to falcon server and remove post processing action from falcon workflow |  Major | . | sandeep samudrala | Praveen Adlakha |
...
| [FALCON-2228](https://issues.apache.org/jira/browse/FALCON-2228) | Falcon should also set the feed output names as a coord property |  Major | . | Pallavi Rao | sandeep samudrala |
...
| JIRA | Summary | Priority | Component | Reporter | Contributor |
|:---- |:---- | :--- |:---- |:---- |:---- |
| [FALCON-2072](https://issues.apache.org/jira/browse/FALCON-2072) | Hive2 URLs in Falcon should allow additional configuration elements in the URL |  Major | . | Venkat Ranganathan | Sowmya Ramesh |
...
| [FALCON-2224](https://issues.apache.org/jira/browse/FALCON-2224) | Change return type of extension APIs to APIResult |  Major | . | Praveen Adlakha | Pracheer Agarwal |
...
| [FALCON-2281](https://issues.apache.org/jira/browse/FALCON-2281) | HiveDRTest tests are getting permissions denied |  Major | . | Cheng Xu | Sowmya Ramesh |
...
| [FALCON-2284](https://issues.apache.org/jira/browse/FALCON-2284) | Error while listing extension jobs |  Major | . | Richie Varghese | Pracheer Agarwal |
...
| JIRA | Summary | Priority | Component | Reporter | Contributor |
|:---- |:---- | :--- |:---- |:---- |:---- |
| [FALCON-1610](https://issues.apache.org/jira/browse/FALCON-1610) | Add instance commands to Falcon spring-shell CLI |  Major | . | Rajat Khandelwal | Praveen Adlakha |
| [FALCON-1611](https://issues.apache.org/jira/browse/FALCON-1611) | Add admin commands to Falcon spring-shell CLI |  Major | . | Rajat Khandelwal | Praveen Adlakha |
| [FALCON-1612](https://issues.apache.org/jira/browse/FALCON-1612) | Add Metadata commands to Falcon spring-shell CLI |  Major | . | Rajat Khandelwal | Praveen Adlakha |
| [FALCON-1780](https://issues.apache.org/jira/browse/FALCON-1780) | Add falcon-cli executable and link that to falcon executable when no arguments are provided |  Major | . | Rajat Khandelwal | Praveen Adlakha |
...
| [FALCON-2181](https://issues.apache.org/jira/browse/FALCON-2181) | Support for storing metadata of non trusted recipe |  Major | . | Praveen Adlakha | Praveen Adlakha |
...
| [FALCON-2184](https://issues.apache.org/jira/browse/FALCON-2184) | Support to delete a non trusted recipe metadata from server |  Major | . | Praveen Adlakha | Praveen Adlakha |
...
| [FALCON-2186](https://issues.apache.org/jira/browse/FALCON-2186) | Rest api to get details of an extension |  Major | . | Praveen Adlakha | Praveen Adlakha |
...
| [FALCON-2164](https://issues.apache.org/jira/browse/FALCON-2164) | NPE exception in GraphiteNotification Plugin |  Major | . | Praveen Adlakha | Praveen Adlakha |
...
| [FALCON-2153](https://issues.apache.org/jira/browse/FALCON-2153) | Resetting Gauge value in BacklogEmitterService |  Major | . | Praveen Adlakha | Praveen Adlakha |
...
| [FALCON-2258](https://issues.apache.org/jira/browse/FALCON-2258) | Improve error message for definition/describe api in case extension does not exist |  Major | . | sandeep samudrala | sandeep samudrala |
...
| [FALCON-2205](https://issues.apache.org/jira/browse/FALCON-2205) | describe for non trusted extension |  Major | . | Praveen Adlakha | Praveen Adlakha |
