...
|:---- |:---- | :--- |:---- |:---- |:---- |
| [TEZ-2096](https://issues.apache.org/jira/browse/TEZ-2096) | TEZ-UI : Add link to view AM log of finished & running apps |  Major | UI | Rajesh Balamohan | Jonathan Turner Eagles |
...
| [TEZ-2886](https://issues.apache.org/jira/browse/TEZ-2886) | Ability to merge AM credentials with DAG credentials |  Major | . | Jason Darrell Lowe | Jason Darrell Lowe |
| [TEZ-2244](https://issues.apache.org/jira/browse/TEZ-2244) | PipelinedSorter: Progressive allocation for sort-buffers |  Major | . | Gopal Vijayaraghavan | Rajesh Balamohan |
| [TEZ-2679](https://issues.apache.org/jira/browse/TEZ-2679) | Admin forms of launch env settings |  Major | . | Jason Darrell Lowe | Jonathan Turner Eagles |
...
| [TEZ-2935](https://issues.apache.org/jira/browse/TEZ-2935) | Add MR slow start translation for ShuffleVertexManager |  Major | . | Jonathan Turner Eagles | Jonathan Turner Eagles |
| [TEZ-2581](https://issues.apache.org/jira/browse/TEZ-2581) | Umbrella for Tez Recovery Redesign |  Major | . | Jeff Zhang | Jeff Zhang |
| [TEZ-3011](https://issues.apache.org/jira/browse/TEZ-3011) | Link Vertex Name in Dag Tasks/Task Attempts to Vertex |  Major | UI | Jonathan Turner Eagles | Jonathan Turner Eagles |
| [TEZ-2972](https://issues.apache.org/jira/browse/TEZ-2972) | Avoid task rescheduling when a node turns unhealthy |  Major | . | Jason Darrell Lowe | Jason Darrell Lowe |
| [TEZ-2129](https://issues.apache.org/jira/browse/TEZ-2129) | Task and Attempt views should contain links to the logs |  Minor | UI | Kevin J. Price | Jonathan Turner Eagles |
...
| [TEZ-2850](https://issues.apache.org/jira/browse/TEZ-2850) | Tez MergeManager OOM for small Map Outputs |  Major | . | Saikat | Jonathan Turner Eagles |
...
| [TEZ-2904](https://issues.apache.org/jira/browse/TEZ-2904) | Pig can't specify task specific command opts |  Major | . | Jonathan Turner Eagles | Jonathan Turner Eagles |
...
| [TEZ-2922](https://issues.apache.org/jira/browse/TEZ-2922) | Tez Live UI gives access denied for admins |  Major | . | Jonathan Turner Eagles | Jonathan Turner Eagles |
...
| [TEZ-2940](https://issues.apache.org/jira/browse/TEZ-2940) | Invalid shuffle max slow start setting causes vertex to hang indefinitely |  Major | . | Jonathan Turner Eagles | Jonathan Turner Eagles |
| [TEZ-2924](https://issues.apache.org/jira/browse/TEZ-2924) | Framework for Hadoop shims |  Major | . | Hitesh Shah | Hitesh Shah |
| [TEZ-2923](https://issues.apache.org/jira/browse/TEZ-2923) | Tez Live UI counters view empty for vertices, tasks, attempts |  Major | UI | Jonathan Turner Eagles | Jonathan Turner Eagles |
...
| [TEZ-2943](https://issues.apache.org/jira/browse/TEZ-2943) | Change shuffle vertex manager to use per vertex data for auto reduce and slow start |  Major | . | Jonathan Turner Eagles | Bikas Saha |
...
| [TEZ-2966](https://issues.apache.org/jira/browse/TEZ-2966) | Tez does not honor mapreduce.task.timeout |  Major | . | Jonathan Turner Eagles | Jonathan Turner Eagles |
...
| [TEZ-2914](https://issues.apache.org/jira/browse/TEZ-2914) | Ability to limit vertex concurrency |  Major | . | Jonathan Turner Eagles | Bikas Saha |
...
| [TEZ-2849](https://issues.apache.org/jira/browse/TEZ-2849) | Implement Specific Workaround for JDK-8026049 & JDK-8073093 |  Major | . | Gopal Vijayaraghavan | Gopal Vijayaraghavan |
...
| [TEZ-2976](https://issues.apache.org/jira/browse/TEZ-2976) | Recovery fails when InputDescriptor is changed during input initialization |  Major | . | Jeff Zhang | Jeff Zhang |
